      ...
      return (
        <div className="flex items-center gap-2">
          <Button asChild variant="ghost" size="icon">
            <Link href={`/quan-tri/nganh-nghe/${row.original.id}`}>
              <Eye />
            </Link>
          </Button>
...
const OccupationDataTable = () => {
  ...
  const occupationQuery = occupationApi.useGetOccupationsQuery(query);
  const occupations = useMemo(
    () => occupationQuery.data ?? [],
    [occupationQuery.data],
  );
      ...
      <div className="w-full">
        <div className="mb-4 flex flex-col items-center gap-4 md:flex-row">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button asChild>
              <Link href="/quan-tri/nganh-nghe/tao-moi">
                <Plus />
                Tạo mới
              </Link>
            </Button>
        ...
        <div className="grid grid-cols-1 rounded-md border">
          <Table
            ...
            isLoading={occupationQuery.isFetching}>
            <TableHeader>
...
export default OccupationDataTable;
